...
html_baseurl = 'https://sphinx.silverrainz.me/incrbuild'
...
extlinks = {
    'issue': ('https://github.com/sphinx-notes/incrbuild/issues/%s', '💬%s'),
    'pull': ('https://github.com/sphinx-notes/incrbuild/pull/%s', '🚀%s'),
    'tag': ('https://github.com/sphinx-notes/incrbuild/releases/tag/%s', '🏷️%s'),
}
